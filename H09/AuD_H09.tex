...
\begin{document}
	...
	\section{H1}
		...
		\subsection{a)}
			...
			\\ \\
			\includegraphics[width=0.69\linewidth]{picture/H1a/Picture10.png}
			\\ \\
			\includegraphics[width=0.76\linewidth]{picture/H1a/Picture11.png}
		...
		\subsection{c)}
			...
			\begin{tabular}{ | c | p{67mm} | p{67mm} |}
				...
				\textbf{Invariante:}	& \parbox{67mm}{
											\vspace{1ex}
											Jeder Knoten hat maximal $2t - 1$ Werte. Bis Auf die Wurzel hat jeder mindestens $t - 1$.
											\vspace{1ex}
										}
										& \parbox{67mm}{
											\vspace{1ex}
											Jeder Kindknoten auf Pfad des zu löschenden Knotens hat mindestens $t - 1$ und maximal $2t -1$ Werte. 
											\vspace{1ex}
										}
				\\ \hline
		...
		\subsection{d)}
			...
			\\ \\
			Beim \textbf{Löschen} wird besonders das Verschmelzen problematisch, da Knoten mit $2t$ Werten immer noch nicht erlaubt sind und andernfalls durch das Löschen Knoten mit weniger als $t$ Werten entstehen würden.
